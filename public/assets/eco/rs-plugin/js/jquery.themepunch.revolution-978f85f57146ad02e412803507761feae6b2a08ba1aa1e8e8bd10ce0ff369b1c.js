			...
			*/
			...
			//////////////////////////////////////////////////////////////////
					...
					container.find('>li').each(function() {
						var li = jQuery(this);
						if (li.index!=opt.act && li.index!=opt.next) li.css({'z-index':1600});
					});

					actli.css({'z-index':1008});
					nextli.css({'z-index':2000});
			...
			if (nexttrans==12 || nexttrans==13 || nexttrans==14 || nexttrans==15) {
					...
					//	kill();
						...
						if (specials == 3) {
								...
								actli.css({'position':'absolute','z-index':2000});
								nextli.css({'position':'absolute','z-index':1500});
						...
						TweenLite.fromTo(ssn,speedy,
										...
										{opacity:1,rotation:0,left:0,top:0,scale:1,ease:easeitin,onComplete:function() {
														letItFree(container,opt,nextsh,actsh,nextli,actli);
														actli.css({'position':'absolute','z-index':1800});
														nextli.css({'position':'absolute','z-index':2000});
												}
			...
			if (nexttrans==16) {						// PAPERCUT
					...
					TweenLite.set(actli.find('.tp-half-two'),
					                 {width:oow,height:ooh,overflow:'hidden',zIndex:1500,position:'absolute',top:ooh/2,left:'0px',transformPerspective:600,transformOrigin:"center bottom"});

					TweenLite.set(actli.find('.tp-half-one'),
					                 {width:oow,height:ooh/2,overflow:'visible',zIndex:1000,position:'absolute',top:'0px',left:'0px',transformPerspective:600,transformOrigin:"center top"});
